...
namespace WebSchool.Service
{
    public class PembayaranService : IPembayaranService
    {
        ...
        public PembayaranService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            _apiConfig = configuration.GetSection(nameof(ApiConfiguration)).Get<ApiConfiguration>();
            _httpContextAccessor = httpContextAccessor;
        }

        public async Task<GlobalObjectListResponseJson<Pembayaran>> CheckAddPembayaran(CheckPembayaranModel model, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                GlobalObjectListResponseJson<Pembayaran> resUnauthorization = JsonSerializer.Deserialize<GlobalObjectListResponseJson<Pembayaran>>(jsonString, options);
            ...
            GlobalObjectListResponseJson<Pembayaran> resData = JsonSerializer.Deserialize<GlobalObjectListResponseJson<Pembayaran>>(content, options);
            return resData;
        }

        public async Task<GlobalResponseJson> AddPembayaran(PembayaranInputModel model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriAddPembayaran);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalResponseJson> UpdatePembayaran(PembayaranUpdateModel model, CancellationToken cancellationToken)
        {
            string Token = "";
            var httpWebRequestCheckToken = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriCheckToken);
            httpWebRequestCheckToken.ContentType = "application/json";
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriUpdatePembayaran);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalResponseJson> DeletePembayaran(IdPembayaran model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriDeletePembayaran);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalObjectListResponseJson<Pembayaran>> PembayaranSearch(SearchPembayaran model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriGetPembayaran);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
