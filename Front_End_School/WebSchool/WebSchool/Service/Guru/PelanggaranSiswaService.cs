...
namespace WebSchool.Service
{
    public class PelanggaranSiswaService : IPelanggaranSiswaService
    {
        ...
        public PelanggaranSiswaService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            _apiConfig = configuration.GetSection(nameof(ApiConfiguration)).Get<ApiConfiguration>();
            _httpContextAccessor = httpContextAccessor;
        }

        public async Task<GlobalResponseJson> AddPelanggaranSiswa(PelanggaranSiswaInputModel model, CancellationToken cancellationToken)
        {
        ...
        public async Task<GlobalResponseJson> UpdatePelanggaranSiswa(PelanggaranSiswaUpdateModel model, CancellationToken cancellationToken)
        {
            string Token = "";
            var httpWebRequestCheckToken = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriCheckToken);
            httpWebRequestCheckToken.ContentType = "application/json";
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriUpdatePelanggaranSiswa);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalResponseJson> DeletePelanggaranSiswa(IdPelanggaranSiswa model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriDeletePelanggaranSiswa);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalObjectListResponseJson<PelanggaranSiswa>> PelanggaranSiswaSearch(SearchPelanggaranSiswa model, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                GlobalObjectListResponseJson<PelanggaranSiswa> resUnauthorization = JsonSerializer.Deserialize<GlobalObjectListResponseJson<PelanggaranSiswa>>(jsonString, options);
                return resUnauthorization;
            }

            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriGetPelanggaranSiswa);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
            ...
            GlobalObjectListResponseJson<PelanggaranSiswa> resData = JsonSerializer.Deserialize<GlobalObjectListResponseJson<PelanggaranSiswa>>(content, options);
            return resData;
        }
    }
}
