...
namespace WebSchool.Service
{
    public class AbsenGuruService : IAbsenGuruService
    {
        ...
        public AbsenGuruService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            _apiConfig = configuration.GetSection(nameof(ApiConfiguration)).Get<ApiConfiguration>();
            _httpContextAccessor = httpContextAccessor;
        }

        public async Task<GlobalObjectListResponseJson<AbsenGuru>> CheckAddAbsenGuru(CheckAddAbsenGuruModel model, CancellationToken cancellationToken)
        {
            ...
            httpWebRequestCheckToken.MediaType = "application/json";
            httpWebRequestCheckToken.Accept = "application/json";
            ...
            else
            {
                ...
                GlobalObjectListResponseJson<AbsenGuru> resUnauthorization = JsonSerializer.Deserialize<GlobalObjectListResponseJson<AbsenGuru>>(jsonString, options);
                return resUnauthorization;
            }

            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriCheckAddAbsenGuru);
            ...
            var jsonCheck = JsonSerializer.Serialize(model, options);

            using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
            {

                streamWriter.Write(jsonCheck);
                streamWriter.Close();
                streamWriter.Dispose();
            }
            ...
            GlobalObjectListResponseJson<AbsenGuru> resData = JsonSerializer.Deserialize<GlobalObjectListResponseJson<AbsenGuru>>(content, options);
            return resData;
        }

        public async Task<GlobalResponseJson> AddAbsenGuru(AbsenGuruInputModel model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriAddAbsenGuru);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalResponseJson> UpdateAbsenGuru(AbsenGuruUpdateModel model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriUpdateAbsenGuru);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
        ...
        public async Task<GlobalObjectListResponseJson<AbsenGuru>> AbsenGuruSearch(SearchAbsenGuru model, CancellationToken cancellationToken)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriGetAbsenGuru);
            httpWebRequest.Headers.Add("Authorization", "Bearer " + Token + "");
            httpWebRequest.Headers.Add("Strict-Transport-Security", "max-age=31536000");
            httpWebRequest.Headers.Add("X-Content-Type-Options", "nosniff");
            httpWebRequest.Headers.Add("X-Xss-Protection", "1; mode=block");
