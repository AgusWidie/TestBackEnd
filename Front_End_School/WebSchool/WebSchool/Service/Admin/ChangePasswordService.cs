...
namespace WebSchool.Service
{
    public class ChangePasswordService : IChangePasswordService
    {
        ...
        public async Task<GlobalResponseJson> GantiPassword(ChangePassword model, CancellationToken cancellationToken)
        {
            string Token = "";
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(_apiConfig.BaseUrl + _apiConfig.UriChangePassword);
